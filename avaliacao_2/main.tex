...
A Tabela~\ref{quad:comparacao} sintetiza as diferenças. Observa-se a dualidade
...
mesma DFT da Equação~\eqref{eq:dft}. O resultado é idêntico ao do cálculo direto, a
diferença está apenas no tempo de execução.
...
independentes, com erros da ordem de $10^{-15}$ para $M = 4$ e sempre inferiores a
$10^{-12}$ nas demais larguras testadas. A generalização da largura evidenciou a
